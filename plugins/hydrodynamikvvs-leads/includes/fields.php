...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'hydrodynamikvvs-leads' ),
				'storm'       => __( 'Storm or hail damage', 'hydrodynamikvvs-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'hydrodynamikvvs-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'hydrodynamikvvs-leads' ),
				'not-sure'    => __( 'Vet inte än', 'hydrodynamikvvs-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'hydrodynamikvvs-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'hydrodynamikvvs-leads' ),
				'research' => __( 'Jag kollar bara priser', 'hydrodynamikvvs-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'hydrodynamikvvs-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'hydrodynamikvvs-leads' ),
		'contacted' => __( 'Kontaktad', 'hydrodynamikvvs-leads' ),
		'quoted'    => __( 'Quote sent', 'hydrodynamikvvs-leads' ),
		'won'       => __( 'Won', 'hydrodynamikvvs-leads' ),
		'lost'      => __( 'Lost', 'hydrodynamikvvs-leads' ),
		'spam'      => __( 'Misstänkt spam', 'hydrodynamikvvs-leads' ),
	);
}
